...
export class NormalCorrectedRayVoxeliser extends IVoxeliser {
    ...
    protected override _voxelise(mesh: Mesh, voxeliseParams: VoxeliseParams): VoxelMesh {
        ...
        this._scale = (voxeliseParams.desiredWidth) / Mesh.desiredHeight;
    ...
    private __getVoxelColour(triangle: UVTriangle, materialName: string, location: Vector3): RGB {
        ...
        // TODO: if this class is used, need to propagate triIndex
        return this._mesh!.sampleMaterial(materialName, uv, this._voxeliseParams!.textureFiltering, -1);
    }
