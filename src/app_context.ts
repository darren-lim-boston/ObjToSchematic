...
export class AppContext {
    ...
    private _import() {
        ...
        const rotation = uiElements.rotate.getCachedValue() == 'none' ? false : true;

        const importer = new ObjImporter(rotation);
    ...
    private _voxelise() {
        ...
        const voxeliseParams: VoxeliseParams = {
            desiredWidth: uiElements.height.getDisplayValue(),
            desiredScale: -1,
        ...
        {
            const voxelSize = 8.0 / voxeliseParams.desiredWidth;
